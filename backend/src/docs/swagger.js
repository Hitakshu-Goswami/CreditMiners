...
const definition = {
  ...
  paths: {
    ...
    "/ai/credit-score": { post: { summary: "Generate explainable credit intelligence assessment", security: [{ bearerAuth: [] }], requestBody: { required: false, content: { "application/json": { schema: { type: "object", properties: { featureVersion: { type: "string" }, windowMonths: { type: "integer", minimum: 1, maximum: 24 }, computeIfMissing: { type: "boolean" }, assessmentType: { type: "string", enum: ["INITIAL", "MONTHLY", "ON_DEMAND", "SIMULATION"] } } } } } }, responses: { 201: { description: "Explainable assessment generated" }, 400: { description: "Feature readiness failed" } } } },
    "/ai/credit-score/{id}": { get: { summary: "Get one explainable credit assessment", security: [{ bearerAuth: [] }], parameters: [{ name: "id", in: "path", required: true, schema: { type: "string", format: "uuid" } }], responses: { 200: { description: "Credit assessment" }, 404: { description: "Assessment not found" } } } },
    "/ai/credit-score/history": { get: { summary: "List historical credit assessments", security: [{ bearerAuth: [] }], responses: { 200: { description: "Credit assessment history" } } } },
    "/ai/credit-score/latest": { get: { summary: "Get latest credit assessment", security: [{ bearerAuth: [] }], responses: { 200: { description: "Latest assessment" } } } },
    "/ai/credit-score/factors": { get: { summary: "Get latest assessment factors", security: [{ bearerAuth: [] }], responses: { 200: { description: "Positive and negative factors" } } } },
    "/ai/credit-score/improvement-plan": { get: { summary: "Get latest improvement roadmap", security: [{ bearerAuth: [] }], responses: { 200: { description: "Improvement roadmap" } } } },
    "/ai/credit-score/confidence": { get: { summary: "Get latest confidence report", security: [{ bearerAuth: [] }], responses: { 200: { description: "Confidence report" } } } },
    "/ai/credit-score/explanation": { get: { summary: "Get latest explainability narrative", security: [{ bearerAuth: [] }], responses: { 200: { description: "Explanation" } } } },
