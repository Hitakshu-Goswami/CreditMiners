...
const answerValidationController = require("../controllers/answerValidation.controller");

const answerValidationValidator = require("../validators/answerValidation.validator");
